...
document.addEventListener("DOMContentLoaded", function () {
    ...
    var three_Var_for_Answer = function () {
        ...
        switch (randBox) {
            case Box1:
                Box1.textContent = "" + Math.round((True_answer * 100)) / 100;
                Box2.textContent = "" + Math.round(Second * 100) / 100;
                Box3.textContent = "" + Math.round((First)) * 100 / 100;
                break;
            case Box2:
                Box2.textContent = "" + Math.round((True_answer * 100)) / 100;
                Box3.textContent = "" + Math.round(Second * 10) / 10;
                Box1.textContent = "" + Math.round(First * 100) / 100;
                break;
            case Box3:
                Box3.textContent = "" + Math.round((True_answer * 100)) / 100;
                Box1.textContent = "" + Math.round((Second * 100) / 100);
                Box2.textContent = "" + Math.round(First * 10) / 10;
                break;
        }
        return True_answer;
    };
    ...
    var Save_Counter_var = setInterval(function () { localStorage.setItem("Counter_var_sker", "" + Counter_var); }, 4000);
